...
exports.blockSchema = joi_1.default.object({
    id: joi_1.default.string().max(64).required(),
    type: joi_1.default.string().max(100).required(),
    variant: joi_1.default.string().max(100).allow(null, ''),
    props: joi_1.default.object().unknown(true).default({}),
    settings: joi_1.default.object().unknown(true).default({}),
    ai: joi_1.default.object({
        provider: joi_1.default.string().optional(),
        suggested: joi_1.default.boolean().optional(),
        summary: joi_1.default.string().allow('', null).optional(),
        prompts: joi_1.default.array().items(joi_1.default.string()).optional(),
        generatedAt: joi_1.default.string().optional(),
        confidence: joi_1.default.number().min(0).max(1).optional()
    }).optional(),
    children: joi_1.default.array().items(joi_1.default.link('#block')).default([])
}).id('block');
exports.createPostSchema = joi_1.default.object({
    ...
    blocks: joi_1.default.array().items(exports.blockSchema).optional(),
